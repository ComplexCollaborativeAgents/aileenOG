...
(defparameter *assimilation-threshold* 0.003 "sage threshold for storing new cases. A low number means we want everything to be in one generalization and that we don't expect disjunctive concepts")
